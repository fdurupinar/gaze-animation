...
public class FaceScript : MonoBehaviour {
    ...
    [HideInInspector] public float exp_happy = 30;
    ...
    //public Vector3 gazeAmp = new Vector3(10f,10f,0f);

    //public float gazeSpeed  = 0.1f;
    //bool gazeNegDirX = false;
    //bool gazeNegDirY = false;
    //public Vector3 cumGazeStep = Vector3.zero;
    //public Vector3 gazeStep = new Vector3(1, 1, 0);
    //float theta;
    ...
    public void Blink() {
        ...
        if(blinkState == NONE) {  //start closing
        ...
        //if(blinkingNow && blinkTimer <= 0) {
        if(blinkState == CLOSING && blinkTimer <= 0) {//closing state complete
        ...
        if(blinkState == OPENING && openTimer <= 0) { //opening state complete;
            blinkState = NONE;
            blinkInProgress = false;
